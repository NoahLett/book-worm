const topics = [
  ...
  { title: 'Do I need to have an account in order to post on BookWorm?', text: 'Yes. In order to create both Wanted and "Sale" posts, you will need to create a free account. Click here to get started on creating your free account.' },
  ...
  { title: 'How can I get started?', text: 'Depending on whether you plan on selling or trading any of your textbooks, you can start with creating a free account. However, if you\'re looking to simply purchase a text book from an existing post, feel free to peruse the Sales page!' },
